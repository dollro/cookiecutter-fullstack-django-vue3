...
# Smart deployment script for smartwakeup
# Usage: ./deploy.sh <target> [docker-compose-args]
# Examples:
#   ./deploy.sh asparuha up -d
#   ./deploy.sh wolpertinger down
#   ./deploy.sh asparuha logs django
